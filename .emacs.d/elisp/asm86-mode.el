...
(defvar masm-struc-base-offset 0
  "*Indentation for a STRUC statement")
(defvar masm-macro-base-offset 0
  "*Indentation for a MACRO statement")
...
(defvar masm-end-base-offset 0
  "*Indentation for a MACRO close")
...
(defvar asm86-group-func-offset 0
  "*Indentation for a GROUP statement")
(defvar masm-struc-func-offset 0
  "*Indentation for a STRUC statement")
...
(defvar asm86-font-lock-keywords
  (list
    (cons
      (concat masm-directive)
      '(. font-lock-keyword-face))
    (cons
      (concat "[^_$]?\\<\\(" masm-api "\\)\\>[^_]?")
      '(. font-lock-function-name-face))
    (cons
      (concat "[^_$]?\\<\\(" masm-register "\\)\\>[^_]?")
      '(. font-lock-variable-name-face))
    (cons
      (concat "[^_$]?\\<\\(" masm-type "\\)\\>[^_]?")
      '(. font-lock-type-face))
    (cons
      (concat "[^_$]?\\<\\(" masm-command "\\)\\>[^_]?")
...
(defun asm86-mode-vars ()
  ...
  (setq asm86-base-indent-vals (list
      ...
      (cons 'masm-struc masm-struc-base-offset)
      (cons 'masm-macro masm-macro-base-offset)
      ...
      (cons 'masm-end masm-end-base-offset)
  ...
  (setq asm86-func-indent-vals (list
      ...
      (cons 'masm-struc masm-struc-func-offset)
      ...
      (let ((line-start (point)) (word-end 0) (line-end (asm86-last-char)))
        ...
        (setq line-type
              (cond 
               ...
               ((word-search-forward "STRUC" line-end t) 'masm-struc) 
               ((word-search-forward "MACRO" line-end t) 'masm-macro) 
               ...
               ((word-search-forward "ENDM" line-end t) 'masm-end)     ; end of a macro
