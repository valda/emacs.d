...
(defconst minibuf-isearch-version "1.6.1"
...
(defun minibuf-isearch-show-completion (&optional nomsg)
...
(defun minibuf-isearch-check-completion ()
  ...
  (if (or (and (assq minibuffer-history-variable
    ...
    (minibuf-isearch-show-completion 'nomsg)))
...
Searches forward when NEXT is non-nil."
  (let* ((enable-recursive-minibuffers t) ; FIXME: ???
	...
	(unwind-protect
		...
		(minibuf-isearch-check-completion))
